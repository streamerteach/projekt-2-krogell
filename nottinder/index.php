    ...
    <main>
        <section class="landing-page">
            <article class="welcome-article">
                ...
                <?php if (!isLoggedIn()): ?>
                    <a href="<?php echo url('pages/register/'); ?>"><button class="nav-btn">Sign Up</button></a>
                <?php else: ?>
                    <a href="<?php echo url('pages/home/'); ?>"><button class="nav-btn">Start Swiping</button></a>
                <?php endif; ?>
            ...
            <div class="preview-profiles">
                ...
                foreach ($previews as $preview): 
                    $image = $preview['profile_image'] ?? 'assets/images/default-avatar.png';
                ?>
                    <div class="preview-card">
                        <img src="<?php echo imageUrl($image); ?>" 
