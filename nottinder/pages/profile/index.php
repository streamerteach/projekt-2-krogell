            ...
            <article class="profile-article">
                <div class="profile-container">
                    ...
                    <div class="profile-image-section">
                        ...
                        <div class="current-image">
                            ...
                            <?php if ($profile_image): ?>
                                <img src="<?php echo htmlspecialchars($profile_image['image_path']); ?>?v=<?php echo time(); ?>" alt="Profile picture">
                            <?php else: ?>
                            ...
                            <div class="gallery-section">
                                ...
                                <?php foreach ($images as $image): ?>
                                    <div class="gallery-item">
                                        <img src="<?php echo htmlspecialchars($image['image_path']); ?>?v=<?php echo time(); ?>" alt="Gallery image">
                                ...
                                <div class="comment-item">
                                    <div class="comment-header">
                                        ...
                                        <?php if ($pc['commenter_id'] != $_SESSION['user_id']): ?>
                                            <a href="/nottinder/pages/admin/report_comment.php?comment_id=<?php echo $pc['id']; ?>&from=profile" class="report-link" onclick="return confirm('Report this comment as inappropriate?')">Report</a>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <?php if (hasRole('admin') || hasRole('manager')): ?>
                                        <div class="comment-actions">
                                            <a href="/nottinder/pages/admin/moderation.php?flag=<?php echo $pc['id']; ?>" class="small-btn">Flag (admin)</a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; ?>
                    ...
                    <div style="margin: 20px 0;">
                        <a href="../guestbook/" class="btn btn-secondary">Write a comment</a>
                    </div>
