            ...
            <div class="admin-container">
                ...
                <div class="admin-cards">
                    <div class="admin-card">
                        ...
                        <a href="<?php echo url('pages/admin/users.php'); ?>" class="btn btn-primary">Manage Users</a>
                    </div>
                    
                    <div class="admin-card">
                        <h3>Moderation</h3>
                        <p>Review flagged messages and comments.</p>
                        <a href="<?php echo url('pages/admin/moderation.php'); ?>" class="btn btn-primary">Moderate Content</a>
                    </div>
                </div>
            </div>
        </section>
