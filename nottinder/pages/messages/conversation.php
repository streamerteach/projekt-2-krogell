...
if (isset($_GET['action']) && $_GET['action'] === 'report' && isset($_GET['msg_id'])) {
    ...
    header("Location: conversation.php?user=" . $other_id);
    exit;
}
        ...
        <section class="conversation-section">
            <div class="conversation-container">
                <div class="conversation-header">
                    ...
                    <h2>
                        <img src="<?php echo htmlspecialchars($other['profile_image'] ?? '/nottinder/assets/images/default-avatar.png'); ?>" alt="" class="small-avatar">
