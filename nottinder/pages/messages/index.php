        ...
        <section class="messages-section">
            <div class="messages-container">
                ...
                <?php if (empty($conversations)): ?>
                    <p>You have no messages yet. <br><a href="<?php echo url('pages/browse/'); ?>">Browse</a> for other users to message someone.</p>
                <?php else: ?>
                    <div class="conversation-list">
                        <?php foreach ($conversations as $conv): 
                            $avatar = $conv['profile_image'] ?? 'assets/images/default-avatar.png';
                        ...
                        ?>
                        <a href="<?php echo url('pages/messages/conversation.php?user=' . $conv['other_id']); ?>" class="conversation-item <?php echo $conv['unread'] > 0 ? 'unread' : ''; ?>">
                            <div class="conv-avatar">
                                <img src="<?php echo imageUrl($avatar); ?>" alt="<?php echo $name; ?>">
                            </div>
                            <div class="conv-info">
