        ...
        <section class="home-layout">
            ...
            <article class="home-article">
                ...
                <div class="navigation-links">
                    <?php if (isLoggedIn()): ?>
                        <a href="<?php echo url('pages/profile/'); ?>" class="nav-link">Go to Profile</a>
                        <a href="<?php echo url('pages/logout.php'); ?>" class="nav-link">Logout</a>
                    <?php else: ?>
                        <a href="<?php echo url('pages/login/'); ?>" class="nav-link">Login here</a>
                        <a href="<?php echo url('pages/register/'); ?>" class="nav-link">Register</a>
                    <?php endif; ?>
                </div>
            </article>
        </section>
