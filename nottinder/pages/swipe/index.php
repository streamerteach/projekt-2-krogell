...
<?php if ($profile): ?>
    <div class="card">
        <?php 
        $image_path = $profile['profile_image'] ?? '/nottinder/assets/images/default-avatar.png';
        ?>
        <img src="<?php echo htmlspecialchars($image_path); ?>" alt="<?php echo htmlspecialchars($profile['full_name'] ?: $profile['username']); ?>">
        ...
        <?php else: ?>
            <p><a href="../login/">Log in</a> to like profiles and see more info.</p>
        <?php endif; ?>
    </div>
<?php else: ?>
    <div class="card">
        ...
        <?php if (isLoggedIn()): ?>
            <p><a href="../browse/">Browse for profiles</a> instead.</p>
        <?php endif; ?>
    </div>
<?php endif; ?>