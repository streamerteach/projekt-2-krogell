...
$image = $profile['profile_image'] ?? 'assets/images/default-avatar.png';
...
<div class="profile-card" data-profile-id="<?php echo $profile['id']; ?>">
    <div class="profile-card-image">
        <img src="<?php echo imageUrl($image); ?>" alt="<?php echo htmlspecialchars($profile['full_name'] ?: $profile['username']); ?>">
    </div>
    ...
    <div class="profile-card-info">
        ...
        <?php if (isLoggedIn() && $profile['id'] != $_SESSION['user_id']): ?>
            ...
            <div class="profile-actions">
                ...
                <a href="<?php echo url('pages/messages/conversation.php?user=' . $profile['id']); ?>" class="btn-message">💬 Message</a>
            </div>
        <?php endif; ?>
    </div>
</div>